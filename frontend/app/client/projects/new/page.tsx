                ...
                <div className="bg-card border border-border rounded-2xl p-6 flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      placeholder="GXXXX..."
                      spellCheck={false}
                      className="w-full rounded-lg border border-border bg-background px-3 py-2.5 text-sm font-sans text-foreground placeholder:text-muted-foreground focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20 transition-colors"
                    />
